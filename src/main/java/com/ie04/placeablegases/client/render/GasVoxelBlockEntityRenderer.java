...
public class GasVoxelBlockEntityRenderer implements BlockEntityRenderer<GasVoxelBlockEntity>
{
    ...
    @Override
    public void render(GasVoxelBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay)
    {
        float occupancy = blockEntity.getGasOccupancy();
        if (occupancy <= 0.0f)
            return;
        ...
        float alpha = 0.06f + occupancy * 0.54f;
    ...
    private static void renderCube(VertexConsumer consumer, Matrix4f matrix, Matrix3f normal, float min, float max, float red, float green, float blue, float alpha, int packedLight)
    {
    ...
    private static void quad(VertexConsumer consumer, Matrix4f matrix, Matrix3f normal, float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4, float normalX, float normalY, float normalZ, float red, float green, float blue, float alpha, int packedLight)
    {
    ...
    private static void vertex(VertexConsumer consumer, Matrix4f matrix, Matrix3f normal, float x, float y, float z, float u, float v, float normalX, float normalY, float normalZ, float red, float green, float blue, float alpha, int packedLight)
    {
