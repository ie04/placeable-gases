...
- Expansion is pass-limited, but buoyancy drift is continuous: lighter-than-air voxel cells rise and heavier-than-air voxel cells sink until blocked. When a cell moves, the old position is restored to air.
